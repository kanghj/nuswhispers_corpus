...
if __name__ == "__main__":
    ...
    with open('full.csv', 'rb') as opened:
        ...
        for row in reader:
            ...
            row[1] = row[1].lower()
            row[1] = row[1].replace('http://www.nuswhispers.com/confession/', '')
            row[1] = row[1].replace('https://www.nuswhispers.com/confession/', '')
            row[1] = row[1].replace('www.nuswhispers.com/confession/', '')
